...
function AddQuestion({ surveyId, getSurvey, EditSurvey, editQuestion }) {
  ...
  const handleEditQuestion = (question, typeId, surveyId, answers) => {
    axios
      .put(
        process.env.REACT_APP_BACKEND_URL + "question/" + editQuestion._id,
        {
          question: question,
          typeId: typeId,
          surveyId: surveyId,
            ...
            <div className="flex gap column center">
              ...
              <div>
                ...
                >
                  ...
                  <option value="6582d04ce29625e896bde17e">Radio</option>
                  <option value="65834f46e29625e896bde187">Checkbox</option>
                  <option value="65834f63e29625e896bde188">Text</option>
                </select>
              </div>
            </div>
